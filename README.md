...
get the app created:
    ...
    $ heroku apps:create penguin
    Creating penguin... done, stack is cedar
    http://penguin.herokuapp.com/ | git@heroku.com:penguin.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://penguin.herokuapp.com deployed to Heroku

    To git@heroku.com:penguin.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://penguin.herokuap.com
    ["Hello" :from Heroku]
